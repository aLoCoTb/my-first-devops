...
**tcp dport 8080 accept** - разрешает входящие TCPсоединения на порт 8080 с любого IPадреса

**tcp dport 80 accept** - разрешает HTTP трафик (порт 80/TCP) с любого IPадреса
